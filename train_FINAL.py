...
datads = TabularDatasetFactory.from_delimited_files(path=webpath,validate='False',separator=',',infer_column_types=True,include_path=False,
set_column_types=None,support_multi_line=False,partition_format=None)

data = datads.to_pandas_dataframe()
